...
func main() {
	...
	flagSet.Bool("set-xtokenrequest", false, "set X-Auth-Request-Token response header (useful in Nginx auth_request mode)")
	...
	flagSet.Bool("cookie-redirect-domain", false, "Optional, cookies will be set to redirect domain header")
